...
export const itemCreateApi = (categoryId, { text, type, choices, grade, allowProportion,
  ...
  const request = {
    ...
    body: JSON.stringify({ text, type, choices, correctAnswer, grade, allowProportion, minSimilarPercent })
  };
...
export const itemUpdateApi = (categoryId, index, { text, type, choices,grade, allowProportion,
  correctAnswer=null, minSimilarPercent=0  }) => {
  const request = {
    method: "PUT",
    headers: {
