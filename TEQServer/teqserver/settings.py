"""
Django settings for teqserver project.
...
MIDDLEWARE = [
    'mainapp.middleware.HandleExceptionsMiddleware',
...
WSGI_APPLICATION = 'teqserver.wsgi.application'
...
ORIGINS = decouple.config("ORIGINS")
